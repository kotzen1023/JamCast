package com.seventhmoon.jamcast.utils;
...
import com.seventhmoon.jamcast.VoiceSearchParams;
...
import static com.seventhmoon.jamcast.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;

public class LocalQueueHelper {
    private static final String TAG = LogHelper.makeLogTag(LocalQueueHelper.class);
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueue(String mediaId,
        ...
        if (categoryType.equals(MEDIA_ID_MUSICS_BY_JAMCAST)) {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueueFromSearch(String query,
                                                                               Bundle queryParams, LocalMusicProvider musicProvider) {
     ...
     */
    public static List<MediaSessionCompat.QueueItem> getRandomQueue(LocalMusicProvider musicProvider) {
