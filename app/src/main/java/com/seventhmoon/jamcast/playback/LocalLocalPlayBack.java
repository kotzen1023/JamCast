...
public class LocalLocalPlayBack implements Playback {
    private static final String TAG = LogHelper.makeLogTag(LocalLocalPlayBack.class);
    ...
    private final LocalMusicProvider mLocalMusicProvider;
                ...
                public void onReceive(Context context, Intent intent) {
                    if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intent.getAction())) {
                        ...
                        if (isPlaying()) {
                            ...
                            i.putExtra(LocalMusicService.CMD_NAME, LocalMusicService.CMD_PAUSE);
    ...
    public LocalLocalPlayBack(Context context, LocalMusicProvider localMusicProvider) {
