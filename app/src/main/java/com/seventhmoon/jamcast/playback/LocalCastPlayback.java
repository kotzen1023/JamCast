...
public class LocalCastPlayback implements Playback {
    ...
    public LocalCastPlayback(LocalMusicProvider localMusicProvider, Context context) {
    ...
    private void loadMedia(String mediaId, boolean autoPlay) throws JSONException {
        ...
        MediaMetadataCompat track = mLocalMusicProvider.getMusic(musicId);
        if (track == null) {
