...
import com.seventhmoon.jamcast.ui.MusicPlayerActivity;
import com.seventhmoon.jamcast.utils.LogHelper;
import com.seventhmoon.jamcast.utils.ResourceHelper;

public class LocalMediaNotificationManager extends BroadcastReceiver {
    private static final String TAG = LogHelper.makeLogTag(LocalMediaNotificationManager.class);

    private static final String CHANNEL_ID = "com.seventhmoon.jamcast.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.seventhmoon.jamcast.pause";
    public static final String ACTION_PLAY = "com.seventhmoon.jamcast.play";
    public static final String ACTION_PREV = "com.seventhmoon.jamcast.prev";
    public static final String ACTION_NEXT = "com.seventhmoon.jamcast.next";
    public static final String ACTION_STOP = "com.seventhmoon.jamcast.stop";
    public static final String ACTION_STOP_CASTING = "com.seventhmoon.jamcast.stop_cast";

    private final LocalMusicService mService;
    ...
    public LocalMediaNotificationManager(LocalMusicService service) throws RemoteException {
        mService = service;
        updateSessionToken();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_STOP_CASTING:
                Intent i = new Intent(context, LocalMusicService.class);
                i.setAction(LocalMusicService.ACTION_CMD);
                i.putExtra(LocalMusicService.CMD_NAME, LocalMusicService.CMD_STOP_CASTING);
